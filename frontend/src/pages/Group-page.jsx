                ...
                <div className="mt-6">
                    <div className="flex  items-center ">
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                className="bg-pink-500 text-white py-2 px-2 rounded-r flex transition-all ease-linear hover:bg-purple-500/80 justify-center items-center space-x-1"
                            >
